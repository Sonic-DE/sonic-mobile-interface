...
void PanelSettingsDBusClient::connectToDBus()
{
    ...
    m_interface = new OrgKdePlasmashellMobilePanelsInterface{QStringLiteral("org.kde.plasmashell"),
                                                             QStringLiteral("/Mobile/Panels/") + QString::number(m_screenId),
...
int PanelSettingsDBusClient::screenId() const
{
    return m_screenId;
}

void PanelSettingsDBusClient::setScreenId(int screenId)
{
    if (screenId == m_screenId) {
        return;
    }
    m_screenId = screenId;
