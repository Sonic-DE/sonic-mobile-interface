...
Item {
    ...
    // clicking outside of tasks closes it
    // TODO taphandler activates even if delegate clicked
//     TapHandler {
//         onTapped: taskSwitcher.hide()
//     }
    ...
    Repeater {
        ...
        delegate: Task {
            ...
            readonly property real listX: taskSwitcherState.xPositionFromTaskIndex(currentIndex);
