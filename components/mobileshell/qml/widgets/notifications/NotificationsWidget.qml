...
Item {
    ...
    ListView {
        ...
        readonly property bool listOverflowing: contentItem.childrenRect.height + toolButtons.height + bottomMargin >= root.height
        
        bottomMargin: spacing * 2
        
        height: count === 0 ? 0 : listOverflowing ? root.height - toolButtons.height - bottomMargin : contentItem.childrenRect.height
