...
Item {
    ...
    ListView {
        ...
        height: count === 0 ? 0 : listOverflowing ? root.height - toolButtons.height - bottomMargin : contentItem.childrenRect.height + bottomMargin
    ...
    Item {
        ...
        width: root.width
        height: toolLayout.implicitHeight - spacer.height + list.spacing * 2
