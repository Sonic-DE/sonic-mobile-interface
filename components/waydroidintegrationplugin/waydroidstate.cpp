...
void WaydroidState::resetWaydroid()
{
    if (m_sessionStatus != SessionStopped) {
        stopSession(); // TODO: Refactor Sync methods with Sync action and change callable methods to call Sync method as Async to avoid block the UI
    }
