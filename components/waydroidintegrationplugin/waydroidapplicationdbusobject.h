...
class WaydroidApplicationDBusObject : public QObject
{
    Q_OBJECT
    QML_ELEMENT
    Q_CLASSINFO("D-Bus Interface", "org.kde.plasmashell.Waydroid.Application")

public:
    explicit WaydroidApplicationDBusObject(const QString &name, const QString &packageName, QObject *parent = nullptr);
     ...
     */
    static std::optional<WaydroidApplicationDBusObject> parseApplicationFromWaydroidLog(QTextStream &inFile);
     ...
     */
    static QList<WaydroidApplicationDBusObject> parseApplicationsFromWaydroidLog(QTextStream &inFile);
