...
Item {
    ...
    Item {
        ...
        QQC2.Control {
            ...
            implicitWidth: Kirigami.Units.gridUnit * 22 // TODO
            ...
            contentItem: ColumnLayout {
                ...
                QQC2.DialogButtonBox {
                    ...
                    function insertButtonsIfNeeded() {
                        console.log('changed ' + standardButtons + ' ' + QQC2.DialogButtonBox.NoButton)
                        if (standardButtons === QQC2.DialogButtonBox.NoButton) {
                            standardButtons = QQC2.DialogButtonBox.Cancel;
                        }
                    }

                    Component.onCompleted: insertButtonsIfNeeded()
                    onStandardButtonsChanged: insertButtonsIfNeeded()
