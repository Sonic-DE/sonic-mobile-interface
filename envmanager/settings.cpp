...
const QString MOBILE_KWINRC_FILE = u"kwinrc-plasma-mobile"_s;
...
{
    // kwinrc (legacy, we only write in the kwinrc-plasma-mobile file now)
...
void Settings::applyMobileConfiguration()
{
    ...
    // ksmserver
    writeKeysAndSave(u"ksmserverrc"_s, m_ksmServerConfig, KSMSERVER_SETTINGS, false);
