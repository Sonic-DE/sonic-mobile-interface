...
void setKey(KConfigGroup &fromGroup, KConfigGroup &toGroup, QString fromKey, QString toKey)
{
...
void DevicePresets::initialize()
{
    ...
    const QString presetFile = QStandardPaths::locate(QStandardPaths::GenericDataLocation, u"plasma-mobile-device-presets/"_s + device + ".conf");
    ...
    for (const auto &p : groupPairs) {
        ...
        setKey(presetGroup, writeGroup, u"statusBarHeight"_s, u"statusBarHeight"_s);
        setKey(presetGroup, writeGroup, u"navigationPanelHeight"_s, u"navigationPanelHeight"_s);
        setKey(presetGroup, writeGroup, u"leftPadding"_s, u"statusBarLeftPadding"_s);
        setKey(presetGroup, writeGroup, u"leftPadding"_s, u"navigationPanelLeftPadding"_s);
        setKey(presetGroup, writeGroup, u"rightPadding"_s, u"statusBarRightPadding"_s);
        setKey(presetGroup, writeGroup, u"rightPadding"_s, u"navigationPanelRightPadding"_s);
        setKey(presetGroup, writeGroup, u"centerSpacing"_s, u"statusBarCenterSpacing"_s);
