...
KCM.SimpleKCM {
    ...
    ColumnLayout {
        ...
        PC3.Button {
            ...
            Layout.alignment: Qt.AlignHCenter
            onClicked: AIP.WaydroidDBusClient.startSessionQml()
        }
    }
    ...
    // ColumnLayout {
    //     visible: AIP.WaydroidDBusClient.errorTitle !== ""
    ...
    //
    //     QQC2.Label {
    //         text: AIP.WaydroidDBusClient.errorTitle
    //         Layout.alignment: Qt.AlignHCenter
    //         horizontalAlignment: Text.AlignHCenter
    //     }
    //
    //     QQC2.TextArea {
    //         visible: AIP.WaydroidDBusClient.errorMessage !== ""
    //         text: AIP.WaydroidDBusClient.errorMessage
    //         readOnly: true
    ...
    //         text: i18n("Go back")
    //         Layout.alignment: Qt.AlignHCenter
    //         onClicked: AIP.WaydroidDBusClient.resetError()
    //     }
    // }
}