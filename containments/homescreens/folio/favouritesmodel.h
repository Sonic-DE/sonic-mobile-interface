...
public:
    ...
    bool canAddEntry(int row, QSharedPointer<FolioDelegate> delegate);
    bool addEntry(int row, QSharedPointer<FolioDelegate> delegate);
    QSharedPointer<FolioDelegate> getEntryAt(int row);
