            ...
            Item {
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        Behavior on columnValue { NumberAnimation { duration: 250; easing.type: Easing.InOutQuad } }
                        Behavior on rowValue { NumberAnimation { duration: 250; easing.type: Easing.InOutQuad } }
                        Behavior on pageValue { NumberAnimation { duration: 250; easing.type: Easing.InOutQuad } }
