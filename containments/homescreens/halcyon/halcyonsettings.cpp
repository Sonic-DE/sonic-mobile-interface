...
const QString CFG_GROUP_HALCYON = u"Halcyon"_s;

const QString CFG_KEY_PINNED = u"pinned"_s;
const QString CFG_KEY_SHOW_WALLPAPER_BLUR = u"wallpaperBlurEffect"_s;
const QString CFG_KEY_DOUBLE_TAP_TO_LOCK = u"doubleTapToLock"_s;
