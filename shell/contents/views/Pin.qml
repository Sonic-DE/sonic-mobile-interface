...
PlasmaCore.ColorScope {
    ...
    visible: true//simManager.pinRequired != OfonoSimManager.NoPin
    ...
    Rectangle {
        ...
        Keys.onPressed: {
            if (event.modifiers === Qt.NoModifier) {
                if (event.key === Qt.Key_Backspace) {
                    ...
                    pinScreen.enter();
                } else if("0123456789".indexOf(event.text) !== -1) {
        ...
        ColumnLayout {
            ...
            Item {
                height: 3 //HACK: Make sure the buttons are located above the panel
            }
        }        
    }
}
