    ...
    : QObject{parent}
{
    m_brightnessInterface =
        new org::kde::Solid::PowerManagement::Actions::BrightnessControl(QStringLiteral("org.kde.Solid.PowerManagement.Actions.BrightnessControl"),
...
{
    QDBusPendingReply<bool> reply = m_brightnessInterface->brightness();
...
{
    QDBusPendingReply<bool> reply = m_brightnessInterface->brightnessMax();
    QDBusPendingCallWatcher *watcher = new QDBusPendingCallWatcher(reply, this);
